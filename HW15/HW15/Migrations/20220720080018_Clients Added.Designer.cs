...
namespace HW15.Migrations
{
    ...
    [Migration("20220720080018_Clients Added")]
            ...
            modelBuilder.Entity("HW15.DbModels.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            Name = "test1",
                            StartedDate = new DateTime(2022, 7, 20, 10, 0, 18, 69, DateTimeKind.Local).AddTicks(2043)
                        },
                        new
                        {
                            ProjectId = 2,
                            ...
                            ClientId = 2,
                            Name = "test2",
                            StartedDate = new DateTime(2022, 7, 20, 10, 0, 18, 69, DateTimeKind.Local).AddTicks(2055)
                        },
                        new
                        {
                            ProjectId = 3,
                            ...
                            ClientId = 3,
                            Name = "test3",
                            StartedDate = new DateTime(2022, 7, 20, 10, 0, 18, 69, DateTimeKind.Local).AddTicks(2057)
                        },
                        new
                        {
                            ProjectId = 4,
                        ...
                        new
                        {
                            ...
                            ClientId = 5,
                            Name = "test5",
                            StartedDate = new DateTime(2022, 7, 20, 10, 0, 18, 69, DateTimeKind.Local).AddTicks(2058)
                        });
                });
